...
<section class="mt-40">
    <Projectsingular nummeret="5" src="ungdomsbyen.png" projektnummer="05" project_name="Ungdomsbyen - 2th semester CMS project" text_project="This project was the first time using a content management system (CMS), in this case Wordpress. The purpose of this assignment was to redesign the website of Ungdomsbyen.dk, in which we had to mainly focus on the information architecture with the purpose of improving the user experience." programmer="Skills & tools used" redskab1="Wordpress (CMS) & PHP" redskab2="HTML" redskab3="CSS" redskab4="Javascript" redskab5="Yoast & Smush" redskab6="Adobe Illustrator"/>
</section>
<section class="mt-40">
